# 🧑‍💻 GEMINI Instructions for Jarvis AI
...
- Sempre utilize o context7 quando for necessário gerar código, realizar etapas de configuração ou setup, ou consultar documentação de biblioteca/API. Isso significa que você deve usar automaticamente as ferramentas MCP do Context7 para resolver o id da biblioteca e obter a documentação, sem que eu precise pedir explicitamente.

## Padrões Específicossim
